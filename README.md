# 🗃️ inventory-bin-count-classifier-aws-sagemaker - Classify Items with Ease
...
## 🌟 Features
This application offers a range of features to enhance your experience:

- **Computer Vision:** Utilizes cutting-edge techniques to identify and count items from images.
- **AWS SageMaker Integration:** Leverages AWS SageMaker for training models effectively.
- **Image Classification:** Classifies counts from 1 to 5 based on analyzed images.
- **Real-time Inference:** Provides instant results through a real-time endpoint.
- **Defensive Cleanup:** Automatically manages files and resources after use.
...
2. Select an image that you want to analyze.
3. Click the 'Classify' button.
4. View the results displayed on the screen with the count of items from the image.
